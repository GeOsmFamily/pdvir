...
class ResourceRepository extends ServiceEntityRepository
{
    ...
    public function findNearestEvents(): array
    {
        return $this->createQueryBuilder('r')
            ...
            ->andWhere('((r.startAt IS NOT NULL AND r.startAt >= :startOfToday) OR (r.endAt IS NOT NULL AND r.endAt >= :startOfToday))')
            ->setParameter('startOfToday', new \DateTime('today 00:00:00'))
