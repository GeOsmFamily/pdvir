 ...
 */
final class Version20241002093519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project RENAME COLUMN title TO name');
        $this->addSql('COMMENT ON COLUMN project.updated_at IS NULL');
        $this->addSql('COMMENT ON COLUMN project.created_at IS NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project RENAME COLUMN name TO title');
