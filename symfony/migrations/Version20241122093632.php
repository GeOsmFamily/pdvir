 ...
 */
final class Version20241122093632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id UUID NOT NULL, actor_id UUID NOT NULL, contracting_organisation_id INT NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, geo_data_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, images JSON DEFAULT NULL, partners JSON DEFAULT NULL, intervention_zone VARCHAR(255) NOT NULL, focal_point_name VARCHAR(255) DEFAULT NULL, focal_point_position VARCHAR(255) DEFAULT NULL, focal_point_email VARCHAR(255) DEFAULT NULL, focal_point_tel VARCHAR(255) DEFAULT NULL, focal_point_photo VARCHAR(255) DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, deliverables TEXT DEFAULT NULL, calendar TEXT DEFAULT NULL, beneficiary_types JSON DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, slug VARCHAR(128) DEFAULT NULL, is_validated BOOLEAN NOT NULL, PRIMARY KEY(id))');
