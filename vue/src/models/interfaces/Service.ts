import service_voirie from '@/assets/images/services/voirie/voirie.png'
import service_risque from '@/assets/images/services/risque/service_risque.png'
import geovoirie_2 from '@/assets/images/services/voirie/geovoirie_2.png'
import geovoirie_1 from '@/assets/images/services/voirie/geovoirie_1.png'
import georisque_1 from '@/assets/images/services/risque/georisque_1.png'
import georisque_2 from '@/assets/images/services/risque/georisque_2.png'
...
export const ServiceDatas: Service[] = [
  {
    isExpanded: true,
    title: 'Module Voirie',
    to: 'https://drive.google.com/file/d/1ZxnVkpAfAUfScDVSMvx01bdybTlTMyR9/view?usp=sharing',
    contents: [
      {
        left: true,
        ...
        image: { src: service_voirie, size: 35 }
      },
      // {
      // left: false,
      ...
      // },
      {
        ...
        image: { src: geovoirie_1, size: 100 }
      },
      {
        left: true,
        ...
        image: { src: geovoirie_2, size: 100 }
      }
    ]
  },
  {
    ...
    to: 'https://drive.google.com/file/d/1CYZucZUKs_Xmi8SJifxzWPqnmDjxg4ou/view?usp=drive_link',
    contents: [
      {
        left: false,
        title: 'Présentation générale',
        ...
        image: { src: service_risque, size: 40 }
      },
      // {
      // left: false,
      //   title: 'Fonctionnalités principales',
      ...
      // },
      {
        ...
        image: { src: georisque_1, size: 100 }
      },
      {
        left: false,
        ...
        image: { src: georisque_2, size: 100 }
      }
    ]
  }
]
