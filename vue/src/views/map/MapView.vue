...
onMounted(() => {
    ...
    map.on('load', () => {
        map.addSource('wms-test-source', {
            ...
            'tiles': [
                'http://localhost:8010/ogc/test?bbox={bbox-epsg-3857}&format=image/png&service=WMS&version=1.1.1&request=GetMap&srs=EPSG:3857&transparent=true&width=256&height=256&layers=countries'
            ],
            'tileSize': 256
        });
        map.addLayer(
