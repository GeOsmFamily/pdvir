<template>
    <div class="HomeMapDescription">
        <div class="HomeMapDescription__block">
            <v-btn variant="outlined" class="show-mobile disabled mb-4 w-100 font-weight-medium" color="main-blue" >{{ $t('home.map.availableOnDesktop') }}</v-btn>
            ...
            <div class="HomeMapDescription__bullets">
              ...
              <v-btn class="mt-4 hide-mobile" color="main-blue" :to="{ name: 'map' }">{{ $t('home.map.action') }}</v-btn>
            </div>
        </div>
...
.HomeMapDescription {
    ...
    .HomeMapDescription__mapImg {
        ...
        img {
            ...
            box-shadow: 0 .125rem .5rem -.125rem rgba(0, 0, 0, 0.4)
        }
