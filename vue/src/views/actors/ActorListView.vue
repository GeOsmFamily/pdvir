    ...
    <div class="ListView ListView--actor">
        ...
        <div class="ListView__filters">
            <ListFilterBox>
                ...
                <ListFilterSelect v-model="selectedThematic" :items="thematicsItems" :label="$t('actors.thematic')"/>
                <ListFilterSelect v-model="selectedAdminScope" :items="administrativeScopesItems" :label="$t('actors.adminScope')"/>
                <ListFilterSelect v-model="selectedCategory" :items="categoryItems" :label="$t('actors.category')"/>
            </ListFilterBox>
            ...
            <div class="ListView__actions">
                ...
                <div>
                    ...
                    <v-btn class="fixed-btn" color="main-red" prepend-icon="mdi-plus" @click="addActor()" v-if="userStore.userIsAdmin() || userStore.userHasRole(UserRoles.EDITOR_ACTORS)">{{ $t('actors.add') }}</v-btn>
                </div>
            </div>
        </div>
