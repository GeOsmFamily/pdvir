  ...
  <AuthDialog>
    ...
    <template #content>
      <Form @submit="onSubmit">
        ...
        <router-link append :to="{ query: { ...$route.query, dialog: DialogKey.AUTH_FORGOT_PASSWORD_OK } }" class="Link--withoutUnderline">
          <v-btn color="main-red" type="submit" block>{{ $t('auth.forgotPassword.form.submit') }}</v-btn>
        </router-link>
      </Form>
    </template>
  </AuthDialog>
