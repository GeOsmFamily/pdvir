<template>
  <div class="AdminPanel">
    <AdminTopBar
      page="Actors"
      :items="commentStore.comments.filter((x) => x.origin === 'Actor')"
      :sortingListItems="[
    ...
    >
      <template #right-buttons>
        <v-btn prepend-icon="mdi-folder-edit-outline" color="main-red">
...
import type { AdminCommentsSortingValues, AppComment } from '@/models/interfaces/Comment'
...
const sortedComments: Ref<AppComment[]> = ref(
  commentStore.getSortedComments('Actor', sortingCommentsSelectedMethod.value)
)
watch(
