        ...
        <template #content>
            <v-form @submit.prevent="submitForm" id="resource-form" class="Form Form--resource">
                ...
                <div class="Form__fieldCtn">
                    ...
                    <v-select density="compact" variant="outlined" chips
                ...
                <div class="Form__fieldCtn">
                    ...
                    <v-select density="compact" variant="outlined"
                        v-model="(form.format.value.value as ResourceFormat)" :items="Object.values(ResourceFormat)"
                        :placeholder="$t('resources.form.fields.format.label')"
                        :item-title="item => $t('resources.resourceFormat.' + item)" :item-value="item => item" :error-messages="form.format.errorMessage.value"
                ...
                <v-divider v-if="!hideFileInput && form.format.value.value">{{ $t('resources.form.or') }}</v-divider>
